...
def get_TT_fisher_matrix(DerivativeTT):
    FM_TT=np.zeros((6,6))
    Cell=np.zeros((1,1))
...
def get_EE_fisher_matrix(DerivativeEE):
    FM_EE=np.zeros((6,6))
    Cell=np.zeros((1,1))
    Cellprime_i=np.zeros((1,1))
    Cellprime_j=np.zeros((1,1))
...
def get_TE_fisher_matrix(DerivativeTT,DerivativeEE,DerivativeTE):
    FM_TE=np.zeros((6,6))
    Cell=np.zeros((1,1))
    Cellprime_i=np.zeros((1,1))
    Cellprime_j=np.zeros((1,1))
...
def get_combined_fisher_matrix(DerivativeTT,DerivativeEE,DerivativeTE):
    FM=np.zeros((6,6))
    Cell=np.zeros((2,2))
...
pars.set_cosmology(thetastar=thetastar_0,ombh2=ombh2_0,omch2=omch2_0,tau=0.0925,omk=0.0,YHe=0.24,mnu=0)
print('As is ok')
print('parameter time= ',time.perf_counter()-time_0)
...
#TT fisher matrix
get_TT_fisher_matrix(DerivativeTT)
#EE fisher matrix
get_EE_fisher_matrix(DerivativeEE)
#TE fisher matrix
get_TE_fisher_matrix(DerivativeTT,DerivativeEE,DerivativeTE)
#combined fisher matrix
get_combined_fisher_matrix(DerivativeTT,DerivativeEE,DerivativeTE)
