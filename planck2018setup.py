...
cosmomc_theta_0=pars.cosmomc_theta
h=0.0001*cosmomc_theta_0
pars.set_cosmology(H0=pars.H0,ombh2=pars.ombh2,omch2=pars.omch2,cosmomc_theta=cosmomc_theta_0-h)
fnresults=camb.get_results(pars)
fnpowers=fnresults.get_cmb_power_spectra(pars, CMB_unit='muK')
fntotCL=fnpowers['total']
pars.set_cosmology(H0=pars.H0,ombh2=pars.ombh2,omch2=pars.omch2,cosmomc_theta=cosmomc_theta_0+h)
...
fppowers=fpresults.get_cmb_power_spectra(pars, CMB_unit='muK')
fptotCL=fppowers['total']
cosmomc_theta_CLprime=(fptotCL-fntotCL)/(2*h)
pars.set_cosmology(H0=pars.H0,ombh2=pars.ombh2,omch2=pars.omch2,cosmomc_theta=cosmomc_theta_0)
print('cosmomc_theta is ok')
...
ax[2,1].plot(ls[2:], cosmomc_theta_CLprime[2:,0]);
ax[2,1].set_title('cosmomc_theta_CLTTprime');
plt.show()
...
ax[2,1].plot(ls[2:], cosmomc_theta_CLprime[2:,1]);
ax[2,1].set_title('cosmomc_theta_CLTEprime');
plt.show()
...
ax[2,1].plot(ls[2:], cosmomc_theta_CLprime[2:,2]);
ax[2,1].set_title('cosmomc_theta_CLEEprime');
plt.show()
...
ax[2,1].plot(ls[2:], cosmomc_theta_CLprime[2:,3]);
ax[2,1].set_title('cosmomc_theta_CLBBprime');
plt.show()
#Noise powerspectrum
NET=350# muk sqrt(s)
N_det=6815
...
DerivativeTT={0:ombh2_CLprime[:,0],1:omch2_CLprime[:,0],2:cosmomc_theta_CLprime[:,0],3:optical_depth_CLprime[:,0],4:As_CLprime[:,0],5:ns_CLprime[:,0]}
DerivativeEE={0:ombh2_CLprime[:,1],1:omch2_CLprime[:,1],2:cosmomc_theta_CLprime[:,1],3:optical_depth_CLprime[:,1],4:As_CLprime[:,1],5:ns_CLprime[:,1]}
DerivativeBB={0:ombh2_CLprime[:,2],1:omch2_CLprime[:,2],2:cosmomc_theta_CLprime[:,2],3:optical_depth_CLprime[:,2],4:As_CLprime[:,2],5:ns_CLprime[:,2]}
DerivativeTE={0:ombh2_CLprime[:,3],1:omch2_CLprime[:,3],2:cosmomc_theta_CLprime[:,3],3:optical_depth_CLprime[:,3],4:As_CLprime[:,3],5:ns_CLprime[:,3]}
